...
//        val totalSegundos = objetoActualSegundos + objetoTSegundos
    ...
    fun incrementar(t: Tiempo): Boolean {
		//TODO: implementar
        val objetTSegundos = t.obtenerSegundos()
        val objetoActualSegundos = this.obtenerSegundos()
        val incremento = objetoActualSegundos + objetTSegundos
    ...
    fun decrementar(t: Tiempo): Boolean {
        ...
        val objetTSegundos = t.obtenerSegundos()
        val objetoActualSegundos = this.obtenerSegundos()
        val decremento = objetoActualSegundos - objetTSegundos
